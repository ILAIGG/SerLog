...
imagen_datos.image = tk.PhotoImage(file="preparativo_envio.png")  # Asegúrese de tener esta imagen
...
imagen_resultados.image = tk.PhotoImage(file="truck.png")  # Asegúrese de tener esta imagen
