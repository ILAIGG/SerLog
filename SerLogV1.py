...
tk.Label(frame_datos, text="Ingresar Datos", fg="white", bg="#444444", font=("Arial", 14)).pack(pady=10)
tk.Label(frame_datos, text="Costo del combustible ($/L):", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Tipo de camión:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Peso de la carga (toneladas):", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Pago del chófer:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Dinero destinado a comida:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Dinero destinado a hotel:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
tk.Label(frame_datos, text="Horario:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Entry(frame_datos).pack(padx=10, pady=5)
map_widget.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True)  # Mantener el mapa visible
tk.Button(frame_datos, text="Confirmar", bg="magenta", fg="white", command=confirmar_datos).pack(padx=10, pady=10)

# Frame de Resultados
frame_resultados = tk.Frame(root, bg="#1c2526")
tk.Label(frame_resultados, text="Resultados", fg="white", bg="#444444", font=("Arial", 14)).pack(pady=10)
tk.Label(frame_resultados, text="Gastos:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Combustible: # Aquí calcularás el costo", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Viativos:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Comida: # Aquí calcularás el costo", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Hotel: # Aquí calcularás el costo", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Peaje: # Aquí calcularás el costo", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Total: # Aquí calcularás el total", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Fecha y Hora:", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Fecha: # Aquí asignarás la fecha", fg="white", bg="#1c2526").pack(padx=10, pady=5)
tk.Label(frame_resultados, text="Hora: # Aquí asignarás la hora", fg="white", bg="#1c2526").pack(padx=10, pady=5)
map_widget.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True)  # Mantener el mapa visible
